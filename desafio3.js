...
const escalaAtual = parseFloat(window.prompt ('Faça a escolha da escala atual:')).toUpperCase();
const conversao = parseFloat(window.prompt ('Digite a temperatura que será ser convertida (F , C, K):')).toUpperCase();
